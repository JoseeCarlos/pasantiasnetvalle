                    ...
                    <td>
                        <ul class="mainmenu">
                            <li id="ContentPlaceHolder1_liSiu">
                                <a id="ContentPlaceHolder1_LKBSiu" title="Gestiona tu información personal" style="display: inline-block; font-size: 13px; height: 50px; width: 440px; margin: 0 5px 0 0;"><b style="font-size: 35px">I</b> NICIO SECRETARIA DE CARRERA</a>
                            </li>
						...
						<fieldset>
							...
							<table cellpadding="0" cellspacing="0" style="border-width:0;" >
								<tr class="LBLContenido">
									...
									<td class="LBLContenido" ><a href="PSolicitudPasantiaSecretaria.aspx"  style="display:inline-block;" class="linkNoticacion">SOLICITUD PASANTIAS</a><h8><asp:Label ID="notNuevo" ForeColor="Red" Font-Bold="true" Text=" - Nuevo" runat="server" /></h8></td>
								</tr>
							</table>
